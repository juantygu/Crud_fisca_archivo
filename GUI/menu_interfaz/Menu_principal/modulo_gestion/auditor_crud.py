...
class AuditorCrud:
    ...
    def mostrar_auditor_crud(self):
        ...
        try:
            ...
            self.elementos.boton_cambiar_id = tk.Button(self.ventana_principal, text="Cambiar ID_auditor",
                                                      ...
                                                      command=self.crear_ventana_credenciales_cambiar_id)
    ...
    def cambiar_id_auditor(self):
        ...
        # ======CAJA ANTIGUO ID ========
        self.elementos.box_antiguo_id = tk.Entry(self.ventana_principal, textvariable=self.elementos.antiguo_id,
        ...
        # ======CAJA NUEVO ID ========
        self.elementos.box_nuevo_id = tk.Entry(self.ventana_principal, textvariable=self.elementos.nuevo_id,
                                                 bd=3, font=("Arial", 12), width=10, insertbackground="blue",
                                                 selectbackground="blue", relief=tk.RIDGE)
    ...
    def crear_ventana_credenciales_cambiar_id(self):
        if not self.elementos.ventana_credenciales_abierta or not self.elementos.ventana_credenciales.winfo_exists():
            ...
            self.elementos.ventana_credenciales.protocol("WM_DELETE_WINDOW", self.cerrar_ventana_credenciales)
        else:
            self.elementos.ventana_credenciales.focus_force()  # Enfoca la ventana existente para mostrarla en la parte delantera

    def cerrar_ventana_credenciales(self):
